    ...
    <footer className="bg-[#030305] pt-20 pb-12 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pt-10 relative z-10">
            ...
            <div className="col-span-1 lg:col-span-2">
                <a href="mailto:hello@xmethod.de" className="block text-3xl font-display font-medium text-white hover:text-[#FFBDFF] transition-colors mb-4">
                    hello@xmethod.de
                </a>
            ...
            <div>
                ...
                <ul className="space-y-2 text-gray-500 text-sm">
                    {['LinkedIn', 'Twitter', 'Instagram', 'Behance'].map(social => (
                        <li key={social}><a href="#" className="hover:text-[#215BFE] transition-colors">{social}</a></li>
                    ))}
                </ul>
            </div>
