                ...
                <div className="relative bg-[#0A0A0C]/60 backdrop-blur-md border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-10 md:p-16 flex flex-col justify-between relative bg-gradient-to-br from-[#171741]/50 to-transparent">
                            ...
                            <div className="space-y-8 mt-16">
                                <div className="group cursor-pointer">
                                    ...
                                    <a href="mailto:itsarmanshekh@gmail.com" className="text-2xl font-display font-medium text-white flex items-center gap-4 hover:translate-x-2 transition-transform duration-300">
                                        itsarmanshekh@gmail.com <ArrowRight size={20} className="text-[#215BFE] opacity-0 group-hover:opacity-100 transition-opacity" />
                                    </a>
                                </div>
                                <div className="flex gap-8">
                                    <div>
                                        <p className="text-xs font-mono text-gray-500 uppercase tracking-widest mb-1">Timezone</p>
                                        <p className="text-white font-mono">Mumbai (India)</p>
                                    </div>
                                    <div>
                        ...
                        <div className="p-10 md:p-16 bg-[#030305]/50 relative border-l border-white/5">
                            ...
                            <div className="absolute bottom-0 left-0 w-16 h-16 border-b border-l border-white/10 "></div>
                            <div className='absolute top-1 bg-white w-full h-5 blur-3xl'></div>
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#ffffff] font-mono text-xs uppercase tracking-widest mb-8">
                                <span className="relative flex h-2 w-2">
                                    <span className="animate-white absolute inline-flex h-full w-full rounded-full bg-[#ffffff] opacity-75"></span>
